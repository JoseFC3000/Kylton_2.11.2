...
MetaDataDecl gameDecls[] = {
	...
	{"name",        	MD_STRING,              "",                 false,      "name",                 "enter name"},
	{"sortname",    	MD_STRING,              "",                 false,      "sort name",            "enter sort name"},
	{"desc",        	MD_MULTILINE_STRING,    "",                 false,      "description",          "enter description"},
	{"image",       	MD_PATH,                "",                 false,      "image",              	"enter path to image"},
	{"image1",       	MD_PATH,                "",                 false,      "image 1",              "enter path to image 1"},
	{"image2",       	MD_PATH,                "",                 false,      "image 2",              "enter path to image 2"},
	...
	{"systemname",    	MD_STRING,              "",                 false,      "system",           	"enter system"},
